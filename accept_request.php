...
if(isset($_POST['confirmBtn'])){
    ...
    if ($stmt->execute() == false){
        echo "Error Confirming Request".nl;
    }
    else {
    ...
    <body>
        <div class="container">
            <div class="col-md-4 col-md-offset-4">
                <div class="row">
                    <h3>Confirm Property?</h3>
                </div>
                <form action="confirm_request.php?booking_id=<?= $booking_id?>" method="post">
                    <p class="alert alert-danger">Are you sure you want to confirm this request?</p>
                    <div class="col-md-offset-4">
                        <button type="submit" name="confirmBtn" class="btn btn-danger btn-lg">Yes</button>
